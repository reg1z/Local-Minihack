...
4. Wait for Vagrant to download and configure each VM.
	- When you boot into the Ubuntu box (fossa) for the first time grub will load. Press enter to get past grub.
	- **DO NOT MESS WITH ANY OF THE VM WINDOWS AFTER THIS POINT UNTIL YOUR MICROTIK ROUTER IS UP**
